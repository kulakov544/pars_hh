...
prod_calendar_holidays = [
    ...
    '2024-04-29', '2024-04-30', '2024-04-27', '2024-05-01', '2024-05-09',
...
df_calendar['to_work'] = df_calendar['work_day'] ^ df_calendar['holidays']
...
df_calendar['month_abbr'] = df_calendar['date'].dt.strftime('%b')
